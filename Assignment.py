...
ax.scatter(dataset['pl_rade'],dataset['st_met'],color='k', s=9,alpha=0.7)
#setting the y-scale to be log for more resolution
ax.set_title('Stellar metallicty v/s log of radius of the planet')
ax.set_xscale('log')
ax.set_xlabel('(Earth)Radius of the planet (R_Earth) (log)')
ax.legend(['planet'])
ax.set_ylabel('Stellar metallicity')
fig3.savefig('q5.png')
...
fig, ax = plt.subplots()
ax.scatter(dataset['pl_bmasse'],dataset['st_met'],color='k', s=9,alpha=0.7)
ax.set_title('Stellar metallicty v/s log of mass of the planet')
ax.legend(['planet'])
#setting the x-scale to be log for more resolution
ax.set_xscale('log')
ax.set_xlabel('(Earth)Mass of the planet (M_Earth) in log scale')
ax.set_ylabel('Stellar metallicity (dex)')
